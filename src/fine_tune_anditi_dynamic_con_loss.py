...
train_transform = MultiViewGenerator(weak_train_transform, strong_train_transform)
...
def main(c, exp_name="all", sampling="inverse", ns_sampling_factor=1):
    ...
    finetune_dir = os.path.join(cwd, c["exp_dir"], f"fine_tune_anditi_dynamic_con_1_{ns_sampling_factor}", sampling)
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        # Train model
        train_results = cnn_utils.train_con_loss(
            data_loader,
            model,
            criterion,
            optimizer,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sampling", help="Chosen non-school sampling method", default="gaussian")
